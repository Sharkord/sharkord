...
export const STORAGE_IMAGE_COMPRESSION_MAX_WIDTH = 1920;
export const STORAGE_IMAGE_COMPRESSION_MAX_HEIGHT = 1080;
export const STORAGE_VIDEO_COMPRESSION_MAX_WIDTH = 1280;
export const STORAGE_VIDEO_COMPRESSION_MAX_HEIGHT = 720;